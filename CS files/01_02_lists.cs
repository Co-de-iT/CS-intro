...
#region Members
  ...
  private void RunScript(ref object A, ref object B, ref object C)
  {
    ...
    List<Point3d> listName = new List<Point3d>();
    ...
    Point3d pt1 = new Point3d(1.0, 0.0, 0.0);
    listName.Add(pt1);

    Point3d pt2 = new Point3d(2.0, 0.0, 0.0);
    listName.Add(pt2);
    ...
    // retrieve the i-est element of the list
    Point3d ptOut = listName[0];
    C = ptOut;
