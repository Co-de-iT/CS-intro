...
#region Members
  ...
  private void RunScript(double x, double y, ref object A)
  {
    ...
    // start from the additional code below
    ...
    // a delegate is a data type, so I can use it to define variables, just as I do with classes
    // (i.e. if I define a class Ball the I can instantiate a Ball b = new Ball(<params>))
    // in the case of delegates, variables should be existing functions with matching signatures
    ...
    // provided that it has the same signature
    // C# automatically assumes that a,b are doubles but I have to return a double as well
  ...
  // define functions with matching signature with the delegate
  // (in this case: 2 doubles as params, returning one double)
  ...
  // define a function that has the delegate as a parameter
